...
<div id="comments" class="clearfix">
	...
	<h3 class="comments-title">
		<?php comments_number(__('', 'framework'), __('1 <span class="custom-word">Comment</span>', 'framework'), __('% <span class="custom-word">Comments</span>', 'framework') );?>
	...
	<div class="trackbacks">
		<h3>
			<?php _e('Trackbacks/Pings', 'framework'); ?>
		</h3>
		<ul>
...
<?php
		...
		// Comment Form Args
		$comments_args = array(
			'reply_text' => __('Reply', 'framework'),
			'cancel_reply_link' => __('Cancel reply', 'framework'),
			'fields' => $fields,
			'title_reply'=>'<h3 class="reply-title"><span>'. __('Leave a <span class="custom-word">reply</span>', 'framework') .'</span><span class="title-arrow"></span></h3>',
