...
class sd_popular_posts_widget extends WP_Widget {
	...
	function sd_popular_posts_widget() {
		...
		$widget_ops = array( 'classname' => 'sd_popular_posts_widget', 'description' => __('A widget to display the popular posts.', 'framework') );
		$control_ops = "";
		$this->WP_Widget( 'sd_popular_posts_widget', __('Popular Posts', 'framework'), $widget_ops, $control_ops );
	}
