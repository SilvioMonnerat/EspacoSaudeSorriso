...
class Options_Machine {
	...
	public static function optionsframework_machine($options) {
		...
		foreach($options as $key => $option) {
			...
			if (!isset($sd_data[$option['id']])) {
				of_save_options($option['std'], $option['id']);
				$options[$key] = $option;
				$sd_data[$option['id']] = $option['std'];
			}
		}
